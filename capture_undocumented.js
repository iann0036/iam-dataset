...
CloudFormation.DescribeChangeSetHooks {3} - cloudformation
DynamoDB.DescribeEndpoints {3} - dynamodb
EC2.ListImagesInRecycleBin {3} - ec2
EC2.RestoreImageFromRecycleBin {3} - ec2
...
WAFV2.GenerateMobileSdkReleaseUrl {3} - wafv2
WAFV2.GetMobileSdkRelease {3} - wafv2
WAFV2.ListMobileSdkReleases {3} - wafv2
